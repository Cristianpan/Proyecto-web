...
<title>Art Zone | Ordenes de Venta</title>
<?php $this->endSection() ?>
...
<main class="order container">
    <h1 class="order__title">Ordenes de Venta</h1>

    <?= empty($orders) ? "<p> No cuenta con ordenes de venta solicitados </p>": '' ?>
            ...
            <div id="<?= $order['saleId'] ?>" class="order-card__body order-card__body--none">
                ...
                foreach ($order['artItems'] as $artItem) : ?>
                    <div class="order-card__products">
                        <h3 class="order-card__title">Obras Vendidas</h3>
